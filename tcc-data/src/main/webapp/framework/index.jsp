...
<head>
    ...
    <script type="text/javascript">
    	function showSystemPage(){
	    	window.location="/framework/login.jsp";
    	}
	</script>
</head>
...
<div class="wrapper">
    <div class="innerWrapper">
                ...
                <div class="contentWrapper">
                    <div class="innerContent">
                        ...
                        <div class="contHeader">
                            <img src="${ctx}/framework/images/logo_reg.png" alt="天润托管座席监控中心" /><span>AgentMap</span>
                        </div>
                        <div class="contBody">
                                <form action="${ctx}/t/businessLogin" method="post">
		                            <ul>
		                                <li>
		                                    <b>企业ID:</b>
		                                    <div class="un">
		                                        <input id="businessId" name="businessId" type="text" maxlength="20" />
		                                    </div>
		                                </li>
		                                <li>
		                                    <b>用户名:</b>
		...
		<!--                            </li> -->
		                                ...
		                                <li>
		                                   	<b>&nbsp;&nbsp;</b>
				                            <div class="error"><span class="loginErrer" id="loginError"><font style="font-weight:600">${error}</font></span></div>
		                                </li>
		<!--                                     <li> -->
		<!--                                         <b>&nbsp;</b> -->
		...
		<!--                                     </li> -->
            ...
            <button class="businessInput" onclick="javascript:showSystemPage();">系统用户登录入口</button>
        <!--body-->
